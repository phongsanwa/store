! function(n) {
    ...
    n("#side-menu").metisMenu(),
        ...
        n(window).on("load", function() {
            ...
            for (t of e.getAttributeNames()) {
                ...
                localStorage.setItem(t, a),
                    document.body.hasAttribute("data-sidebar") ? localStorage.removeItem("data-topbar") : document.body.hasAttribute("data-topbar") && localStorage.removeItem("data-sidebar")
            }
        ...
        n(document).ready(function() {
            var t;
            0 < n("#sidebar-menu").length && 0 < n("#sidebar-menu .mm-active .active").length && (300 < (t = n("#sidebar-menu .mm-active .active").offset().top) && (t -= 300,
        ...
        n("#mode-setting-btn").on("click", function(t) {
            a.hasAttribute("data-layout-mode") && "dark" == a.getAttribute("data-layout-mode") ? ("dark" == localStorage.getItem("data-sidebar") && "horizontal" !== a.getAttribute("data-layout") && document.body.setAttribute("data-sidebar", "dark"),
                "dark" == localStorage.getItem("data-topbar") && "horizontal" !== a.getAttribute("data-layout") && (document.body.setAttribute("data-sidebar", "light"),
                    document.body.setAttribute("data-topbar", "dark")),
                document.body.setAttribute("data-layout-mode", "light"),
                "dark" !== localStorage.getItem("data-topbar") && (document.body.setAttribute("data-topbar", "light"),
                    l("topbar-color-light")),
                "brand" == localStorage.getItem("data-sidebar") && document.body.setAttribute("data-sidebar", "brand"),
                localStorage.getItem("data-sidebar") || localStorage.getItem("data-topbar") || document.body.removeAttribute("data-sidebar")) : ("dark" == localStorage.getItem("data-sidebar") && document.body.setAttribute("data-sidebar", "dark"),
        ...
        a.hasAttribute("data-layout") && "horizontal" == a.getAttribute("data-layout") ? (l("layout-horizontal"),
            n(".sidebar-setting").hide()) : l("layout-vertical"),
        a.hasAttribute("data-layout-mode") && "dark" == a.getAttribute("data-layout-mode") ? l("layout-mode-dark") : l("layout-mode-light"),
        a.hasAttribute("data-layout-size") && "boxed" == a.getAttribute("data-layout-size") ? l("layout-width-boxed") : l("layout-width-fuild"),
        a.hasAttribute("data-layout-scrollable") && "true" == a.getAttribute("data-layout-scrollable") ? l("layout-position-scrollable") : l("layout-position-fixed"),
        "light" != a.getAttribute("data-topbar") && "dark" == a.getAttribute("data-topbar") ? l("topbar-color-dark") : l("topbar-color-light"),
        a.hasAttribute("data-sidebar-size") && "sm" == a.getAttribute("data-sidebar-size") ? l("sidebar-size-small") : a.hasAttribute("data-sidebar-size") && "md" == a.getAttribute("data-sidebar-size") ? l("sidebar-size-compact") : l("sidebar-size-default"),
        a.hasAttribute("data-sidebar") && "brand" == a.getAttribute("data-sidebar") ? l("sidebar-color-brand") : a.hasAttribute("data-sidebar") && "dark" == a.getAttribute("data-sidebar") ? l("sidebar-color-dark") : l("sidebar-color-light"),
        ...
        n("input[name='layout-mode']").on("change", function() {
            "light" == n(this).val() ? (document.body.setAttribute("data-layout-mode", "light"),
                ...
                l("topbar-color-light"),
                l("sidebar-color-light")) : (document.body.setAttribute("data-layout-mode", "dark"),
                document.body.setAttribute("data-topbar", "dark"),
                document.body.setAttribute("data-sidebar", "dark"),
        ...
        n("input[name='layout-direction']").on("change", function() {
            "ltr" == n(this).val() ? (document.getElementsByTagName("html")[0].removeAttribute("dir"),
