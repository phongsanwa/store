                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="code" name="code" type="text" class="form-control" placeholder="Vd: color, size,...">
                                            @error('code')
                                    ...
                                    <div class="col-sm-6 right-create" data-select2-id="8">
                                        <div class="mb-3">
                                            ...
                                            <select id="categories" name="categories[]" multiple="multiple" class="form-control form-select custom-select bg-white border-left-0 border-md">
