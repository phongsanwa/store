                                    ...
                                    <div class="d-flex">
                                        <div class="search-box me-2 mb-2 d-inline-block">
                                            <div class="position-relative">
                                                <input type="text" class="form-control" placeholder="Nhập ID khách hàng">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-check data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="align-middle fw-bold">Email</th>
                                        <th class="align-middle fw-bold">Vai trò</th>
                                            ...
                                            <td class="setting-custom">
                                                <div class="d-block text-center dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="dropdown-item" href="{{ route('users.edit',$p->id) }}"><i class="fal fa-pencil"></i>Sửa khách hàng</a></li>
